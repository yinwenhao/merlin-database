...
public class NettyClient {
	...
	public NettyClient(String address, int port, Sender sender, int threadNumForOneChannel,
			long periodMilliSecondsForReconnect) {
		...
		ResponseHandler responseHandler = new ResponseHandler(sender);
