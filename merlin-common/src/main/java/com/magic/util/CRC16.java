...
public class CRC16 {
	...
	public void update(byte b) {
		int ucCRCHi = (crc & 0xff00) >> 8;
		int ucCRCLo = crc & 0x00ff;
		int iIndex;
	...
	public void update(int i) {
		this.update(int2byte(i));
	}

	public void update(long i) {
		this.update(long2bytes(i));
	}
	...
	public static void main(String[] args) {
		...
		byte[] aaa = new byte[] { 0x02, 0x05, 0x00, 0x03, (byte) 0xff };
		CRC16 c = new CRC16();
		c.update(aaa);
		c.update((byte) 0x00);
		System.out.println(Integer.toHexString(c.getValue()));
	}
}
